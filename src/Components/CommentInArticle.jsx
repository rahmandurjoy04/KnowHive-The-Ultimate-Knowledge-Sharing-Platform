...
const CommentInArticle = () => {
    ...
    if(!user){
       return <p className='text-center py-10 text-3xl bg-gray-100 rounded-b-lg'>Please Login to Like & Comment</p>
    }
    return (
        <div className="flex flex-col max-w-lg p-6 space-y-6 overflow-hidden rounded-b-lg shadow-md dark:bg-gray-50 dark:text-gray-800">
            ...
            <form onSubmit={handleComment}>
                <fieldset className="fieldset">
                    <legend className="fieldset-legend text-blue-500">Write Your Comment Here</legend>
                    <textarea name='comment' className="textarea h-24 w-full text-blue-500" placeholder="Your Comment"></textarea>
                </fieldset>
